      ...
      <div className="brawl-header">
        <div className="brawl-logo-container">
          ...
          <div className="brawl-nav-buttons">
            <button className="brawl-nav-button" onClick={handleMatchPredictionsClick}>MATCH PREDICTIONS</button>
            <button className="brawl-nav-button" onClick={goToPrediction}>MATCH PREDICTIONS 2</button>
            <button className="brawl-nav-button">PLAYER STATS</button>
          </div>
        </div>
